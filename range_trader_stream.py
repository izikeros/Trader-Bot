...
def handle_message(msg):
    ...
    # If the message is a trade: print time, symbol, price, and quantity
        ...
        print(
            "Time: {} Side: {} Symbol: {} Price: {} Quantity: {} ".format(
                timestamp, event_side, msg["s"], msg["p"], msg["q"]
            )
        )
...
client = Client(
    api_key=binance_client.get_apiKey(), api_secret=binance_client.get_secret_key()
)

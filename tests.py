...
def investigate_range():
    fifteen_minute_data = e.get_market_data(
        base_asset="BTC", quote_asset="USDT", interval="15m", num_periods=10
    )
    final_data_set = []
    # format data_set
    for i in fifteen_minute_data:
        ...
        final_data_set.append(
            ["BTC", "USDT", close_time, high_px, low_px, closing_px, num_trades]
        )
